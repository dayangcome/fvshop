...
<body style="background-color: #f2f9fd">
    ...
    <div class="leftnav">
        ...
        <ul style="display: block">
            <li><a href="${ctx}/itemCategory/findBySql" target="right"><span class="icon-caret-right"></span>水果管理</a> </li>
            <li><a href="${ctx}/itemCategory/findBySql33" target="right"><span class="icon-caret-right"></span>蔬菜管理</a> </li>
    ...
    <ul class="bread">
        <li><a href="${ctx}/itemCategory/tj" target="right" class="icon-home">首页</a> </li>
    </ul>
    <div class="admin">
