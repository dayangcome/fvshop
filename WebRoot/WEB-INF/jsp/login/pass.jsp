...
<script>
    $(".con").click(function(){
        ...
        var que = $("#que").val();
        if(jiu==null||jiu==''){
            swal("提示", "旧密码不能为空！", "warning", {
                button: "确认",
            });
            return false;
        }
        if(xin==null||xin==''){
            swal("提示", "新密码不能为空！", "warning", {
                button: "确认",
            });
            return false;
        }
        if(que==null||que==''){
            swal("提示", "确认密码不能为空！", "warning", {
                button: "确认",
            });
            return false;
        }
        ...
        if(xin==yuan){
            swal("提示", "新密码和旧密码不能一样！", "warning", {
                button: "确认",
            });
            return false;
        }
        if(xin!=que){
            swal("提示", "新密码和确认密码输入不一致！", "warning", {
                button: "确认",
            });
            return false;
        }
